...
class EditorShortcuts {
  ...
  static Map<ShortcutActivator, Intent> getShortcuts() {
    ...
    final LogicalKeyboardKey modifierKey =
        PlatformService.isMacOS ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control;

    return {
      // Save shortcut (Command+S or Ctrl+S)
      SingleActivator(LogicalKeyboardKey.keyS, meta: PlatformService.isMacOS, control: !PlatformService.isMacOS):
          const SaveNoteIntent(),
    };
  }
}
